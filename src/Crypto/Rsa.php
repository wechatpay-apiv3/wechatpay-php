...
class Rsa
{
     ...
     * @param \OpenSSLAsymmetricKey|\OpenSSLCertificate|resource|string $publicKey - A PEM encoded public key.
     *
     ...
     * @param \OpenSSLAsymmetricKey|\OpenSSLCertificate|resource|string $privateKey - A PEM encoded private key.
     *
