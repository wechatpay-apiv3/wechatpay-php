...
const EV3_RES_HEADERS_INCOMPLATE = 'The response\'s Headers incomplete, must have(`%1$s`, `%2$s`, `%3$s` and `%4$s`).';
...
interface WeChatPayException
{
    ...
    const EV3_RES_HEADERS_INCOMPLATE = EV3_RES_HEADERS_INCOMPLATE;
